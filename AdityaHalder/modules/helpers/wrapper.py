                ...
                button = [
                    [
                        InlineKeyboardButton(
                            "💥 Deploy HKz Userbot ✨",
                            url=f"https://github.com/HarshKajalHK/HKz-Userbot"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://telegra.ph/file/56ed0d678660191e6030c.jpg",
                                title="🥀 HKz Userbot ✨",
                                thumb_url=f"https://telegra.ph/file/56ed0d678660191e6030c.jpg",
                                description=f"🌷 Deploy Your Own HKz-Userbot 🌿...",
                                caption=f"<b>🥀 Welcome » To » HKz 🌷\n✅ Userbot {__version__} ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Contact To HK For Userbot Sudo❗...\n\nSudo:** <i>https://t.me/llxHKxll</i>||"
                                ),
                            )
                        )
                    ],
